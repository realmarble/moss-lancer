class LocalStorage {
  ...
  Read() {
    try {
      return JSON.parse(localStorage.getItem(this.key)) == null ? -1 : JSON.parse(localStorage.getItem(this.key));
    } catch (error) {
      return -1
    }}
...
Warning : {
    ...
    { DisplayName: "System Override", Name: "DurandalOverride" }
    ]
},
SFX : {
  effects: [
    ...
    { DisplayName: "JOUST Startup", Name: "JoustStartup"},
...
Misc : {
  types : [
    ...
    { DisplayName: "IFrame Display", Name: "FrameViewerSFX" },
    { DisplayName: "Eval", Name: "Eval" },
  ]
}
}};
this.Config.EditorAssemblies = {
  BriefingEditor:{
    ...
    DataSections:[
      ...
      try {
        introoptions.innerHTML = await foundry.applications.handlebars.renderTemplate(`modules/moss-lancer/templates/briefings/settingtemplates/intro/${this.value}.html`,{})
      ...
      },
      {
        ...
        onchange:async function () {
            ...
            try {
              briefingoptions.innerHTML = await foundry.applications.handlebars.renderTemplate(`modules/moss-lancer/templates/briefings/settingtemplates/layout/${this.value}.html`,{})
    ...
    DataSections:[
        {
            ...
            onchange:async function () {
                ...
                try {
                    introoptions.innerHTML = await foundry.applications.handlebars.renderTemplate(`modules/moss-lancer/templates/warnings/settingtemplates/${this.value}.html`,{})
        ...
        },
        {
            ...
            Action Color:<input type="color" name="ActionColor" value="#DFFF00"/><br/>
            Font Size:<input type="text" name="FontSize" value="3em" />`
    ...
    DataSections:[
        {
            ...
            onchange:async function () {
                ...
                try {
                    introoptions.innerHTML = await foundry.applications.handlebars.renderTemplate(`modules/moss-lancer/templates/sfx/settingtemplates/${this.value}.html`,{})
    ...
    DataSections:[
        {
            ...
            onchange:async function () {
                ...
                try {
                    introoptions.innerHTML = await foundry.applications.handlebars.renderTemplate(`modules/moss-lancer/templates/misc/settingtemplates/${this.value}.html`,{})
