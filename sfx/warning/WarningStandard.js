class WarningStandard extends SFX {
  ...
  Play() {
    ...
    popup.innerHTML = `<div id="animation${salt}" class="centered" style="height: 1px;width: 30px;border: 1px solid ${this.context.BorderColor};transition: .75s;z-index: 20;">
